from kimi import App, UI, Term, Key
...
class Dashboard(App):
    ...
    def on_ui(self):
        ...
        # -------- Card --------
        card_sub = f"Alerts: {self.alert_count} | Thr: {self.brightness}%"
        ...
        UI.label(self.ctx,
                 f"{Term.DIM}{self._latest_event}{Term.RESET}", x=2)
    ...
    def _setup_default_keybindings(self):
        ...
        self.keybindings.bind(Key.ESCAPE, self._on_escape, phase="early")
